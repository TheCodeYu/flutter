...
class LoginDialog extends Dialog with BaseWidget {
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        RawMaterialButton(
                          fillColor: BaseWidget.defaultColor,
                          elevation: 0,
                          ...
                          onPressed: () {
                            ...
                            Navigator.pushNamed(context, '/login',
                                arguments: {'type': 'signin'});
                          },
                          child: Container(
                            height: dp(50),
                            decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.all(Radius.circular(dp(4))),
                            ),
                            child: Center(
                              child: Text(
                                '账号登录',
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius:
                                    BorderRadius.all(Radius.circular(4)),
                                border: Border.all(
                                    width: dp(1), color: Color(0xffffcac4)),
                              ),
                              child: Center(
                                child: Text(
                                  '快速注册',
